...
public class UpgradeLog {
  ...
  private static File
      upgradeLogPath = // 升级日志文件upgrade.txt的文件对象，其路径为"data/system/upgrade/upgrade.txt"
  ...
  public static String
      getUpgradeLogPath() { // 获取升级日志文件upgrade.txt的文件对象的路径，"data/system/upgrade/upgrade.txt"
